...
Other ways to phrase the issue described above are:
...
\label{sec:contrib}
\prompt{Keeping in mind the category from Section~\ref{sec:cat} and your research question(s) from~\ref{sec:rq}, these are some potential contributions of my research}{3}
...
\longblock{Details to keep in mind are}
